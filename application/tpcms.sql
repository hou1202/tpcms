...
CREATE TABLE `order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `order_num` varchar(15) NOT NULL DEFAULT '' COMMENT '订单流水号',
  `address_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '收货地址ID',
  `money_sum` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单总金额',
  `money_coupon` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单优惠金额',
  `money_sport` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单运费金额',
  `money_pay` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单实付金额',
  `coupon_id` int(11) unsigned DEFAULT NULL COMMENT '优惠券ID',
  `integral` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单积分',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '订单状态：1=》待付款；2=》待收货；3=》待评价；4=》已完成；5=》退换货；6=》取消订单',
  `pay_type` tinyint(3) unsigned DEFAULT NULL COMMENT '支付方式：1=》微信；2=》支付宝；3=》余额',
  `pay_time` int(10) unsigned DEFAULT NULL COMMENT '支付时间（时间戳）',
...
CREATE TABLE `user` (
  ...
  `money` float(8,2) unsigned DEFAULT '0.00' COMMENT '帐户余额',
  `integral` float(8,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '积分',
...
INSERT INTO `user` VALUES (1,'Libai','96e79218965eb72c92a549dd5a330112','18297905432',0.00,0.00,0,NULL,0,NULL,'2018-10-10 15:08:34',NULL),(2,'Wangwei','96e79218965eb72c92a549dd5a330112','13564078415',0.00,0.00,0,NULL,0,NULL,'2018-10-10 15:08:55',NULL),(3,'Dufu','96e79218965eb72c92a549dd5a330112','17333007330',0.00,0.00,0,NULL,0,NULL,'2018-10-10 15:09:11',NULL);
