...
CREATE TABLE `logistics` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='订单售后产品回寄物流公司';
...
CREATE TABLE `message` (
  ...
  `vice_title` varchar(255) DEFAULT NULL COMMENT '内容副标题',
  `content` text COMMENT '内容正文',
  `sort` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '排序',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='信息内容表';

#
# Data for table "message"
#

INSERT INTO `message` VALUES (1,'关于Aoogi','关于Aoogi','&lt;p&gt;\n\t&lt;img src=&quot;/uploads/20190129/5c4fe3aa11300.jpg&quot; alt=&quot;&quot; /&gt; \n&lt;/p&gt;\n&lt;p&gt;\n\t我们的牛逼不是你所能了解的\n&lt;/p&gt;\n&lt;p&gt;\n\t我们都是好孩子&amp;nbsp;\n&lt;/p&gt;\n&lt;p&gt;\n\t我们可以干什么 呢\n&lt;/p&gt;\n&lt;p&gt;\n\t我们要做什么呢\n&lt;/p&gt;',95,'2019-01-29 13:26:04'),(3,'使用帮助','使用帮助手册','使用帮助手册',96,'2019-01-29 13:33:57');
...
CREATE TABLE `notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID；若为0则，表示所有用户',
  `title` varchar(255) DEFAULT NULL COMMENT '消息标题',
  `content` text COMMENT '消息内容',
  `type` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '消息类型',
  `delete_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除，0表示正常，时间戳表示删除',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='用户消息通知表';

#
# Data for table "notice"
#

INSERT INTO `notice` VALUES (1,2,'下单成功','您所购买的产品已经下单成功，系统正在为您安排发货！',1,0,'2019-01-28 13:55:36'),(2,0,'新年快乐','恭祝所有用户新年快乐！！',1,0,'2019-01-28 13:56:21'),(3,0,'新年好礼','新年下单所有用户都有好礼相送哦！！！',1,0,'2019-01-29 10:25:01');
...
CREATE TABLE `tickling` (
  ...
  `reply` text COMMENT '平台回复',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '处理状态：0=》未处理；1=》已处理',
  `delete_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
INSERT INTO `tickling` VALUES (1,2,'你们的软件是不是有问题啊','/uploads/20190130/5c513199203a0.jpg',NULL,0,1548836786,'2019-01-30 13:11:35'),(2,2,'预计1月30日14时至31日14时，黄淮中南部、江淮中北部、江汉北部等地有大雪，其中河南东部和西部山区、湖北西北部、山东南部、江苏北部、安徽北部等地的部分地区有暴雪（10～18毫米），上述地区积雪深度3～6厘米，局地可达8厘米以上','/uploads/20190130/5c513f7572420.png-/uploads/20190130/5c513f746e988.jpg-/uploads/20190130/5c513f7569398.jpg-/uploads/20190130/5c513f7460ec8.jpg','您的反馈信息我们已经收到，感谢您的反馈',1,0,'2019-01-30 14:08:53'),(3,2,'“关键少数”身处关键岗位、关键领域、关键环节，一旦发生严重违纪违法问题，往往“一查一大片、一挖一大窝”，严重破坏一个地方的政治生态，影响恶劣',NULL,NULL,0,0,'2019-01-30 14:17:57');
...
INSERT INTO `user` VALUES (1,'Libai','96e79218965eb72c92a549dd5a330112','18297905432','/static/index/images/default-head-1.png',0.00,0.00,1,NULL,1,0,'2018-10-10 15:08:34','2019-01-03 18:23:09'),(2,'李白诗','96e79218965eb72c92a549dd5a330112','13564078415','/uploads/20190128/5c4e6c51e3198.png',652481.00,11334.90,0,'1990-12-02',1,0,'2018-10-10 15:08:55','2019-01-28 10:53:02'),(5,'用户7006','96e79218965eb72c92a549dd5a330112','18297905431','/static/index/images/default-head-0.png',0.00,0.00,0,NULL,1,0,'2018-12-17 14:00:49','2019-01-04 17:14:34'),(6,'用户70888','96e79218965eb72c92a549dd5a330112','13564078418','/static/index/images/default-head-1.png',0.00,0.00,1,'2019-01-09',1,0,'2018-12-17 14:02:38','2019-01-03 20:19:20');
