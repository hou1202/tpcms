...
$(function(){
    ...
    var pageAjax = {
        ...
        topNav : $(".classifySlide"),   //分类导航
        classify : $(".nav-active").attr('data-classify-id'),
        onOff : true,
        ...
        getDataInit : function(){
            ...
            mui.ajax("/goods/pageData/"+pageAjax.classify+"/"+pageAjax.pageNo+"/"+pageAjax.pageSize+"",{
                dataType:'json',
                type:'get',
                timeout:10000,
        ...
        clickAjax : function(){
            pageAjax.topNav.on("click",function(){
                ...
                pageAjax.classify = $(this).attr('data-classify-id');
